...
class WC_Sendinblue_Settings extends WC_Settings_Page {
				...
				array(
					...
					array(
						...
						'desc'     => '<br><p><b>' . __( 'Have an account', 'wc_sendinblue' ) . '? </b>' . sprintf(
							...
							" <a target='_blank' href='https://my.sendinblue.com/advanced/apikey/?utm_source=woocommerce_addon&utm_medium=plugin&utm_campaign=module_link'>" . __( 'here.', 'wc_sendinblue' ) . '</a> '
						) . sprintf(
							__( 'Do not have a Sendinblue account? %s', 'wc_sendinblue' ),
							"<a target='_blank' href='https://app.sendinblue.com/account/register?utm_source=woocommerce_addon&utm_medium=plugin&utm_campaign=module_link'>" . __( 'Sign up', 'wc_sendinblue' ) . '</a>'
						) . '</p>',
					),
	...
	public function ws_email_campaign_follow_contacts() {
		...
		<tr valign="top">
			...
			<td class="forminp" style="padding-top: 0px;">
				...
				<?php
				echo sprintf(
					__( 'Please copy/paste comma-separated email addresses.%1$s If you want to send a campaign to more than 1000 email addresses, we advise you to send your campaign directly from %2$s.', 'wc_sendinblue' ),
					'<br>',
					'<a href="">Sendinblue</a>'
				);
				?>
	...
	public function ws_email_campaign_send() {
		...
		<table class="form-table">
			...
			<tr valign="top">
				<th scope="row" class="titledesc">
					<label for=""><?php esc_html_e( 'Message', 'wc_sendinblue' ); ?></label>
				</th>
				<td class="forminp">
					...
					<p class="description"><?php printf( __( '> You can insert HTML or simple text in the text input.%1$s > You must have UNSUBSCRIBE tag wihin your html or a variable {} in your footer to create a valid campaign.%2$s It\'s important that the user is able to unsubscribe from your list.', 'wc_sendinblue' ), '<br>', '<br>' ); ?></p>
				</td>
			</tr>
			<tr valign="top">
				<th scope="row" class="titledesc">
					<label for=""><?php esc_html_e( 'Send a test email', 'wc_sendinblue' ); ?></label>
				</th>
				<td class="forminp">
					<table class="form-ws-table">
						<tr>
							<td><input type="email" name="" id="" class="input-text regular-input"/><a href="javascript:void(0);" class="button"><?php esc_html_e( 'Send', 'wc_sendinblue' ); ?></a></td>
						</tr>
						<tr>
							<td>
								...
								<input name="" id="ws_email_send_campaign_btn" class="button-secondary" type="button" value="<?php esc_html_e( 'Send My Campaign', 'wc_sendinblue' ); ?>">
